...
public class RedisController {
    ...
    @RequestMapping(value = "pushkeyvalue")
    public void pushkeyvalue(String key ,String value){
        redisService.pushkeyvalue(key,value);
    }
    @RequestMapping(value = "rangekeyvalue")
    public List<String> rangekeyvalue(String key ){

        return redisService.rangekeyvalue(key);
    }
