...
public class OrderControl {
    ...
    public String listOrderByUserId(long userid, Model model) {
        ...
        customOrderInfo.setUserid(userid);
        List<Ordermain> orderList = orderService.findOrderByVo(customOrderInfo);
        model.addAttribute("orderlist",orderList);
        return "orderList";
    }
    ...
    @RequestMapping(value = "checkRefreshOrderTime")
    public void checkRefreshOrderTime() {
        orderService.refreshOrderTime();
    }
    ...
    @RequestMapping(value = "listCachedOrder")
    public String listCachedOrder(Model model) {
        List<Ordermain> orderList = orderService.getCachedOrders();
        model.addAttribute("orderlist",orderList);
